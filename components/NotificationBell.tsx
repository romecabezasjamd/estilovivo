        ...
        <div className="fixed top-6 right-6 z-[100]">
            <div className="relative">
                <button
                    ...
                    className="w-11 h-11 bg-[var(--bg-card)]/90 backdrop-blur-md border border-[var(--border-light)] shadow-md rounded-full flex items-center justify-center relative hover:bg-[var(--bg-card)] transition-colors"
                >
