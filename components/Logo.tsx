...
const Logo: React.FC<LogoProps> = ({
    ...
    const symbol = (
        ...
        >
            {/* Estructura del armario - Azul Petróleo (se adapta en modo oscuro) */}
            <rect
            ...
            {/* Barra y Perchas Abstractas - Lavanda/Coral */}
            <path
                d="M28 32 H72"
